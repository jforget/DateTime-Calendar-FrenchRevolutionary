...
my @tests_time = ([" 1 Fructidor 0212, 6:95:80", "%e %B %Y, %H:%M:%S", 212, 12, 1, 6, 95, 80],
	["6:95:80 PM", "%T %p", 212, 12, 1, 6, 95, 80],
	["6:95:80 PM", "%r",    212, 12, 1, 6, 95, 80],
	# almost every accessor at once
	[<<"RES", <<"FMT",      212, 12, 1, 2, 51, 25],
year: 212
